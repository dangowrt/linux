 ...
 * from a "pcs-handle" fwnode property defined in firmware node.
 *
 * If available_pcs is NULL, the count of the parsed PCS from a "pcs-handle"
 * fwnode property is returned (or an error).
 *
